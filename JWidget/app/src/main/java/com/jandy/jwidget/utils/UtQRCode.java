...
public class UtQRCode {
    ...
    public static Bitmap syncEncodeQRCode(String content, int size) {
        return syncEncodeQRCode(content, size, Color.BLACK, Color.WHITE, ErrorCorrectionLevel.L ,null);
    }
     ...
     */
    public static Bitmap syncEncodeQRCode(String content, int size, int foregroundColor,ErrorCorrectionLevel level) {
        return syncEncodeQRCode(content, size, foregroundColor, Color.WHITE, level,null);
    }
     ...
     */
    public static Bitmap syncEncodeQRCode(String content, int size, int foregroundColor, ErrorCorrectionLevel level,Bitmap logo) {
        return syncEncodeQRCode(content, size, foregroundColor, Color.WHITE, level,logo);
    }
     ...
     * @param logo            二维码图片的logo
     */
    public static Bitmap syncEncodeQRCode(String content, int size, int foregroundColor, int backgroundColor, ErrorCorrectionLevel level ,Bitmap logo) {
        try {
            Map<EncodeHintType,Object> hints = new HashMap<EncodeHintType, Object>();
            hints.put(EncodeHintType.ERROR_CORRECTION, level != null ? level : ErrorCorrectionLevel.L);
