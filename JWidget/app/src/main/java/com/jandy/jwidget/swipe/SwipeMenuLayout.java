package com.jandy.jwidget.swipe;
...
public class SwipeMenuLayout extends ViewGroup {
    ...
    //滑动展开或者关闭状态回调
    private OnSmoothChangeListener smoothChangeListener = null;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //NLogger.e(TAG, "onLayout() called with: " + "changed = [" + changed + "], l = [" + l + "], t = [" + t + "], r = [" + r + "], b = [" + b + "]");
        int childCount = getChildCount();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        //NLogger.d(TAG, "dispatchTouchEvent() called with: " + "ev = [" + ev + "]");
        if (isSwipeEnable) {
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (Math.abs(getScrollX()) > 10) {//2016 09 29 修改此处，使屏蔽父布局滑动更加灵敏，
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
...
/*                    if (!mScroller.isFinished()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    //NLogger.i(TAG, "onTouch A ACTION_UP ACTION_CANCEL:velocityY:" + velocityX);
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        //NLogger.d(TAG, "smoothClose() called with:getScrollX() " + getScrollX());
    }
    ...
    public void setSmoothChangeListener(OnSmoothChangeListener listener) {
        smoothChangeListener = listener;
    }

    private void onSmoothState(boolean isExpand) {
        if (smoothChangeListener == null) return;
        smoothChangeListener.onSmoothState(isExpand);
    }

    public interface OnSmoothChangeListener {
        void onSmoothState(boolean isExpand);
    }
}
